...
class PopFunk : 
    ...
    def __init__ ( self, movement, selectedTempo ) : 
        ...
        self.groupLayers = {
            'rhythm': { 'layers': [ 'bass3', 'bass2', 'drumsKit', 'rightPiano', 'rightPiano2', 'rhythmChords' ] , 'heavy': 6, 'lite': 2, 'medium': 4 } , 
        ...
        self.MaxAndMinLayersForEnergy = { 
            'high'  : { 'max': 9,  'min': 2, 'initialMax': 7,  'initialMin': 5, 'loRangeMax': 1, 'loRangeMin': 1 }, 
            'medium': { 'max': 8,  'min': 2, 'initialMax': 4,  'initialMin': 3, 'loRangeMax': 1, 'loRangeMin': 1 }, 
            'low'   : { 'max': 6,  'min': 1, 'initialMax': 2,  'initialMin': 1, 'loRangeMax': 1, 'loRangeMin': 1 }, 
            }
        

        self.arrange = Arranging ( "PopFunk", self.layers, False ) #useDefault = False 
        ...
        for i in beatArray :
            ...
            if ( i in backBeat ) : 
                ...
                BeatInfo[i] = { 
                    ...
                    'snare':   { 'probMax': 100, 'probMin': 99,  'velocityMax': 125,  'velocityMin': 110 }, 
