...
class Anthematic: 
    ...
    def __init__ ( self, movement, selectedTempo ) : 
        ...
        self.arrange = Arranging ( "Anthematic", self.layers, False ) #useDefault = False 
        ...
        self.possibleKeys = MusicTheory.MinorKeys
