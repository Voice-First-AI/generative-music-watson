...
class EDM : 
    ...
    def __init__ ( self, movement, selectedTempo ) : 
        ...
        self.MaxAndMinLayersForEnergy = { 
            'high'  : { 'max': 8,  'min': 1, 'initialMax': 7,  'initialMin': 6, 'loRangeMax': 4, 'loRangeMin': 1 }, 
            'medium': { 'max': 8,   'min': 1, 'initialMax': 4,  'initialMin': 3, 'loRangeMax': 3, 'loRangeMin': 1 }, 
            'low'   : { 'max': 8,   'min': 1, 'initialMax': 2,  'initialMin': 1, 'loRangeMax': 2, 'loRangeMin': 0 }, 
            }
        

        self.arrange = Arranging ( "EDM", self.layers, False ) #useDefault = False 
    ...
    def setPercussionSettings ( self, tse ) : 
        ...
        for i in beatArray :
            ...
            if ( i in backBeat ) : 
                ...
                BeatInfo[i] = { 
                    'kick' :   { 'probMax': 100, 'probMin': 100, 'velocityMax': 120, 'velocityMin': 110 }, 
                    'lowDkick' :   { 'probMax': 0, 'probMin': 0, 'velocityMax': 0, 'velocityMin': 0 }, 
                    'snare':   { 'probMax': 100, 'probMin': 95,  'velocityMax': 125,  'velocityMin': 120 }, 
                    'lowDsnare':   { 'probMax': 0, 'probMin': 0, 'velocityMax': 1, 'velocityMin': 0 }, 
                    'hihat':   { 'probMax': 0, 'probMin': 0, 'velocityMax': 90,  'velocityMin': 60 }, 
                    'lowDhihat':   { 'probMax': 0, 'probMin': 0, 'velocityMax': 80,  'velocityMin': 50 }, 
                ...
                BeatInfo[i] = { 
                    'kick' :   { 'probMax': 100, 'probMin': 100, 'velocityMax': 120, 'velocityMin': 110 }, 
                    'lowDkick' :   { 'probMax': 0, 'probMin': 0, 'velocityMax': 0, 'velocityMin': 0 }, 
                    'snare':   { 'probMax': 0, 'probMin': 0, 'velocityMax': 1, 'velocityMin': 0 }, 
                    'lowDsnare':   { 'probMax': 0, 'probMin': 0, 'velocityMax': 1, 'velocityMin': 0 }, 
                    'hihat':   { 'probMax': 50, 'probMin': 35, 'velocityMax': 80, 'velocityMin': 70 }, 
                    'lowDhihat':   { 'probMax': 0, 'probMin': 0, 'velocityMax': 80,  'velocityMin': 50 }, 
                    'bass' :   { 'probMax': 0, 'probMin': 0, 'velocityMax': 0, 'velocityMin': 0 }, 
                    }         
                ...
                BeatInfo[i] = { 
                    ...
                    'hihat':       { 'probMax': 1, 'probMin': 0, 'velocityMax': 100, 'velocityMin': 85 }, 
                    'lowDhihat':   { 'probMax': 1, 'probMin': 0, 'velocityMax': 80,  'velocityMin': 50 }, 
                    'bass' :   { 'probMax': 0, 'probMin': 0, 'velocityMax': 0, 'velocityMin': 0 }, 
                    }
                ...
                BeatInfo[i] = { 
                    'kick' :       { 'probMax': 0, 'probMin': 0, 'velocityMax': 0, 'velocityMin': 0 }, 
                    'lowDkick' :   { 'probMax': 0, 'probMin': 0, 'velocityMax': 0, 'velocityMin': 0 }, 
                    'snare':       { 'probMax': 1, 'probMin': 0, 'velocityMax': 1,  'velocityMin': 0 }, 
                    'lowDsnare':   { 'probMax': 25, 'probMin': 15, 'velocityMax': 50, 'velocityMin': 40 }, 
                    'hihat':       { 'probMax': 0, 'probMin': 0, 'velocityMax': 110, 'velocityMin': 90 }, 
                    'lowDhihat':   { 'probMax': 0, 'probMin': 0, 'velocityMax': 80,  'velocityMin': 50 }, 
                    'bass' :       { 'probMax': 0, 'probMin': 0, 'velocityMax': 0, 'velocityMin': 0 }, 
                    }
                ...
                BeatInfo[i] = { 
                    'kick' :   { 'probMax': 1, 'probMin': 0, 'velocityMax': 0, 'velocityMin': 0 }, 
                    'lowDkick' :   { 'probMax': 1, 'probMin': 0, 'velocityMax': 0, 'velocityMin': 0 }, 
                    'snare':   { 'probMax': 1, 'probMin': 0,  'velocityMax': 1,  'velocityMin': 0 }, 
                    'lowDsnare':   { 'probMax': 1, 'probMin': 0, 'velocityMax': 1, 'velocityMin': 0 }, 
                    'hihat':   { 'probMax': 100, 'probMin': 100, 'velocityMax': 110,  'velocityMin': 110 }, 
                    'lowDhihat':   { 'probMax': 1, 'probMin': 0, 'velocityMax': 80,  'velocityMin': 50 }, 
                    'bass' :   { 'probMax': 1, 'probMin': 0, 'velocityMax': 0, 'velocityMin': 0 }, 
                    }
            ...
            #        probMaxSnare = 0 
             ...
             #       probMaxHihat = 0 
                ...
                BeatInfo[i] = { 
                    'kick' :   { 'probMax': 0,  'probMin': 0, 'velocityMax': 80,  'velocityMin': 60 }, 
                    'lowDkick' :   { 'probMax': 0, 'probMin': 0, 'velocityMax': 90, 'velocityMin': 70 }, 
                    'snare':   { 'probMax': 20, 'probMin': 10,  'velocityMax': 50,  'velocityMin': 20 }, 
                    'lowDsnare':   { 'probMax': 0, 'probMin': 0, 'velocityMax': 80, 'velocityMin': 50 }, 
                    'hihat':   { 'probMax': 50, 'probMin': 35, 'velocityMax': 60,  'velocityMin': 40 }, 
